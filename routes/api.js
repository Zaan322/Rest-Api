...
loghandler = {
    notparam: {
        ...
        getApikey: 'apikey gratis https://wa.me/6282291992581'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey gratis https://wa.me/6282291992581'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------ZanGanteng'+'Zan--GANS';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'ToukaBotApi') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'ToukaBotApi') return res.json(loghandler.invalidKey)
